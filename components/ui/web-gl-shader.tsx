  ...
  useEffect(() => {
    ...
    const initScene = () => {
      try {
        ...
        console.warn("[WebGLShader] WebGL not supported or failed to initialize on this device:", e)
        return false // Fail gracefully without crashing
      }
